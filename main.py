...
products={
    ...
    '1С':{'info':'1С - это программная система «1С:Предприятие». Изначально она создавалась как расширяемая бухгалтерская система с собственным встроенным языком программирования, но в дальнейшем охватила многие функции продуктов классов ERP, CRM, HRM, SCM.', 'price':'123'},
